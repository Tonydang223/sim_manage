        ...
        <Layout style={{ minHeight: '100vh' }}>
            ...
            >
                <div className="demo-logo" style={{ textAlign: 'center', margin: collapsed ? '10px' : '25px' }}>
                    <span>
                        <img src={LogoSample} alt="The Name" width={'100%'} height={55} />
                    </span>
                </div>
                <CustomMenu
                    style={{ backgroundColor: '#2C3E50' }}
            ...
            <Layout className="site-layout">
                ...
                <Content style={{ margin: '0 16px', overflow: 'initial' }}>
                    <Breadcrumb
                        items={[
                            {
                                title: `${current.charAt(1).toUpperCase()}` + `${current.substring(2, current.length)}`,
                            },
                        ]}
                        style={{ margin: '16px 0' }}
                    />
                    <div style={{ padding: 24, background: '#fff', minHeight: '85vh' }}>{props.children}</div>
                </Content>
            </Layout>
        </Layout>
    );
